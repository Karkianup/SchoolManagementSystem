  ...
  @endsection
    ...
    <div class="nav">
         <select name="logout" onchange="location = this.value;">>
             <option selected disabled id="a">{{ Session::get('fullname') }}</option>
             <option value="logoutUser">Logout</option>
 
         </select>
     </div>
     <div class="sidebar">
         <a href="/studentHome">Home</a><hr>
         <a href="/viewOwnMarks">View Marks</a><hr>
         <a href="/showAttendance">View Attendance</a><hr>
